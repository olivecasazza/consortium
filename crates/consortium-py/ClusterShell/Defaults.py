# Backend shim: this module is the upstream ClusterShell 1.10.1 pure-Python
# implementation, vendored into the rust backend's Python layer. It runs on
# top of the Rust-backed RangeSet (ClusterShell._consortium) exposed through
# ClusterShell/RangeSet.py. See PLAN.md in this directory for the layering.
#
#
